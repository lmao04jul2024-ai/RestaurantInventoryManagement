...
const variantClasses: Record<Variant, string> = {
  primary:
    'bg-primary-600 text-on-primary shadow-sm shadow-primary-600/25 hover:bg-primary-700 hover:shadow-md hover:shadow-primary-600/25 focus-visible:ring-primary-500',
  secondary:
    'bg-secondary-600 text-on-secondary shadow-sm shadow-secondary-600/25 hover:bg-secondary-700 hover:shadow-md hover:shadow-secondary-600/25 focus-visible:ring-secondary-500',
  outline:
